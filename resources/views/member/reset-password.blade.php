    ...
    <div class="container margin-bottom">
        <div class="col-lg-12 forget-pass-bg forget-pass-box">
            <div class="forget-pass-area">
                ...
                <form id="reset-password" method="post" action="{{ route('members.forget-password.reset-password.post') }}">
                    <div class="forget-pass-text-Topic">
                        <b>{{ __('frontend.reset_password') }}</b>
                    </div>
                    <div class="form-group">
                        <label for="">{{ trans('frontend.reset_code') }}</label>
                        <input type="text" class="form-control" name="reset_code" value="{{ old('reset_code', $reset_code) }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="reset-password1" class="form-control" name="password">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="btn-box">
                            <button class="btn-ok" type="submit">{{ __('frontend.reset_password') }}</button>
                        </div>
                    </div>
