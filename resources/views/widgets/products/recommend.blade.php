        ...
        <div class="promotion-header">
            <div class="row">
                <div class="col-sm-8 col-xs-6 promotion-title">
                    {{ trans('frontend.product_recmmend') }}
                </div>
            </div>
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 no-padding">
            <div class="owl-carousel" id="product-recommend">
    ...
    <script>
        $(window).ready(function() {
            ...
            IMPRESSION_PRODUCTS.push({
                'name': '{{ env('GA_RECOMMENDED_PRODUCT_LIST', 'Recommended product list') }}',
                'items': {}
            })
